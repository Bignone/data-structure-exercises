...
class Vehiculo
{
    public:
        ...
        bool pEquals(Vehiculo *v);
        int compare(Vehiculo v);
        int pCompare(Vehiculo *v);
        void setViajes(pLista viajes);
        pLista getViajes();
        pViaje randomViaje(int dia);
        bool buscarViaje(pViaje viaje);
        void borrarViaje(pViaje viaje);
        void insertarViaje(pViaje viaje);
